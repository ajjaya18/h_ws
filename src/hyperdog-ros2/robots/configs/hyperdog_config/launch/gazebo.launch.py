...
def generate_launch_description():
    ...
    config_pkg_share = launch_ros.substitutions.FindPackageShare(
        package="hyperdog_config"
    ).find("hyperdog_config")
    descr_pkg_share = launch_ros.substitutions.FindPackageShare(
        package="hyperdog_description"
    ).find("hyperdog_description")
    ...
    default_model_path = os.path.join(descr_pkg_share, "xacro/hyperdog.urdf.xacro")
