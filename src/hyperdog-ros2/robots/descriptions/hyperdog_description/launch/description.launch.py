...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="hyperdog_description").find("hyperdog_description")
    default_model_path = os.path.join(pkg_share, "xacro/hyperdog.urdf.xacro")
